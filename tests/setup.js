...
<div class="container">
  ...
  <section class="quick-links" id="quick-links">
    ...
    <div class="page page--pomodoro">
      <div class="pomodoro-container">
        <div class="pomodoro-modes">
          <button class="pomodoro-mode-btn active" data-mode="focus">专注</button>
          <button class="pomodoro-mode-btn" data-mode="shortBreak">短休</button>
          <button class="pomodoro-mode-btn" data-mode="longBreak">长休</button>
        </div>
        <div class="pomodoro-timer">
          <svg class="pomodoro-ring" viewBox="0 0 240 240">
            <circle class="pomodoro-ring-bg" cx="120" cy="120" r="110" fill="none" stroke="var(--border)" stroke-width="4"/>
            <circle class="pomodoro-ring-fg" id="pomodoro-progress-ring" cx="120" cy="120" r="110" fill="none" stroke="var(--accent)" stroke-width="4" stroke-linecap="round" stroke-dasharray="691.15" stroke-dashoffset="0" transform="rotate(-90 120 120)"/>
          </svg>
          <div class="pomodoro-time" id="pomodoro-time">25:00</div>
        </div>
        <div class="pomodoro-controls">
          <button class="pomodoro-btn" id="pomodoro-start" title="开始">
            <svg viewBox="0 0 24 24"><polygon points="5 3 19 12 5 21 5 3"/></svg>
          </button>
          <button class="pomodoro-btn" id="pomodoro-pause" title="暂停" style="display:none">
            <svg viewBox="0 0 24 24"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>
          </button>
          <button class="pomodoro-btn" id="pomodoro-reset" title="重置">
            <svg viewBox="0 0 24 24"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>
          </button>
        </div>
        <div class="pomodoro-sessions" id="pomodoro-dots">
          <span class="pomodoro-dot"></span><span class="pomodoro-dot"></span>
          <span class="pomodoro-dot"></span><span class="pomodoro-dot"></span>
        </div>
      </div>
    </div>
...
<footer class="settings-bar">
    ...
    <button id="pomodoro-toggle" class="settings-btn" title="番茄钟">
      <svg viewBox="0 0 24 24"><circle cx="12" cy="13" r="8"/><path d="M12 9v4l2.5 2.5"/><path d="M9 2h6"/><path d="M12 2v2"/></svg>
    </button>
